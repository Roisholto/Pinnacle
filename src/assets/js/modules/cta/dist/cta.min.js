...
!(function () { function a (a) { for (var b, c = 0, d = typeof a === 'string' ? a.split(/\s*,\s*/) : [], e = d.length; e--;)b = d[e], c = Math.max(parseFloat(b) || 0, c); return c } function b (b) { var c = 0; var d = 0; var g = 0; var k = 0; var l = window.getComputedStyle(b) || {}; var m = l[e + h]; c = Math.max(a(m), c); var n = l[e + i]; d = Math.max(a(n), d); l[f + i]; k = Math.max(a(l[f + i]), k); var o = a(l[f + h]); return o > 0 && (o *= parseInt(l[f + j], 10) || 1), g = Math.max(o, g), g || c } function c (a) { var b = window.getComputedStyle(a); return b.background || b.backgroundColor } function d (a, e, f, h) { if (typeof f === 'function' && (h = f, f = {}), !g) return void (h && h(e)); var i, j, l, m, n; f = f || {}, f.duration = f.duration || k.duration, f.targetShowDuration = f.targetShowDuration || b(e) || k.targetShowDuration, f.relativeToWindow = f.relativeToWindow || k.relativeToWindow, f.extraTransitionDuration = f.extraTransitionDuration || k.extraTransitionDuration, window.getComputedStyle(e).display === 'none' && e.style.setProperty('display', 'block', 'important'), i = c(e), j = c(a), l = e.getBoundingClientRect(), m = a.getBoundingClientRect(), scaleXRatio = m.width / l.width, scaleYRatio = m.height / l.height, diffX = m.left - l.left, diffY = m.top - l.top, e.style.removeProperty('display'), n = document.createElement('div'), n.style.setProperty('pointer-events', 'none', 'important'), n.style.setProperty('position', f.relativeToWindow ? 'fixed' : 'absolute', 'important'), n.style.setProperty('-webkit-transform-origin', 'top left', 'important'), n.style.setProperty('transform-origin', 'top left', 'important'), n.style.setProperty('transition', f.duration + 's ease'), n.style.setProperty('width', l.width + 'px', 'important'), n.style.setProperty('height', l.height + 'px', 'important'), n.style.setProperty('left', l.left + (f.relativeToWindow ? 0 : window.pageXOffset) + 'px', 'important'), n.style.setProperty('top', l.top + (f.relativeToWindow ? 0 : window.pageYOffset) + 'px', 'important'), n.style.setProperty('background', j, 'important'), n.style.setProperty('-webkit-transform', 'translate(' + diffX + 'px, ' + diffY + 'px) scale(' + scaleXRatio + ', ' + scaleYRatio + ')', 'important'), n.style.setProperty('transform', 'translate(' + diffX + 'px, ' + diffY + 'px) scale(' + scaleXRatio + ', ' + scaleYRatio + ')', 'important'), document.body.appendChild(n); n.offsetTop; return n.style.setProperty('background', i, 'important'), n.style.removeProperty('-webkit-transform'), n.style.removeProperty('transform'), n.addEventListener('transitionend', function o () { n.removeEventListener('transitionend', o), h && h(e), n.style.transitionDuration = f.targetShowDuration + f.extraTransitionDuration + 's', n.style.opacity = 0, setTimeout(function () { n.parentNode.removeChild(n) }, 1e3 * (f.targetShowDuration + f.extraTransitionDuration)) }), function (b, c) { d(e, a, b, c) } } var e; var f; var g = (function () { return void 0 !== window.ontransitionend || void 0 !== document.documentElement.style.transition }()); var h = 'Duration'; var i = 'Delay'; var j = 'IterationCount'; e = void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend ? 'WebkitTransition' : 'transition', f = void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend ? 'WebkitAnimation' : 'animation'; var k = { duration: 0.3, targetShowDuration: 0, extraTransitionDuration: 1, relativeToWindow: !1 }; d.isSupported = g, typeof exports === 'object' ? module.exports = d : typeof define === 'function' && define.amd ? define(function () { return d }) : window.cta = d }())
