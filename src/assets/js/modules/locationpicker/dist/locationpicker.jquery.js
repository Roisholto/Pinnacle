...
(function ($) {
  ...
  function updateMap (gmapContext, $target, options) {
    var settings = $.extend({}, $.fn.locationpicker.defaults, options); var latNew = settings.location.latitude; var lngNew = settings.location.longitude; var radiusNew = settings.radius; var latOld = gmapContext.settings.location.latitude; var lngOld = gmapContext.settings.location.longitude; var radiusOld = gmapContext.settings.radius
