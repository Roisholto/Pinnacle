(function ($) {
  ...
  function updateMap (gmapContext, $target, options) {
    ...
    var lngNew = settings.location.longitude

    var radiusNew = settings.radius

    var latOld = gmapContext.settings.location.latitude

    var lngOld = gmapContext.settings.location.longitude
